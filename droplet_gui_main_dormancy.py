...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        ui.reg=0
        ui.Numpre=0
        ui.actionITV0010.triggered.connect(lambda: self.function_change(0))
        ui.actionITV0050.triggered.connect(lambda: self.function_change(1))
        ui.actionITV0090.triggered.connect(lambda: self.function_change(2)) 
        ui.actionsingle.triggered.connect(lambda: self.pressure_number(0)) 
        ui.actiondouble.triggered.connect(lambda: self.pressure_number(1)) 
        ...
        action_group1.addAction(ui.actionITV0010)
        action_group1.addAction(ui.actionITV0050)
        action_group1.addAction(ui.actionITV0090)
        action_group2 = QActionGroup(self)
        action_group2.addAction(ui.actionsingle)
        action_group2.addAction(ui.actiondouble)
