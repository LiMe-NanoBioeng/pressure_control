...
class Ui_Droplet_formation(object):
    def setupUi(self, Droplet_formation):
        ...
        self.recordButton.setGeometry(QtCore.QRect(410, 650, 90, 50))
        font = QtGui.QFont()
        ...
        self.abort.setGeometry(QtCore.QRect(850, 720, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(200, 670, 141, 31))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1349, 24))
