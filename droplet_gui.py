...
class Ui_Droplet_formation(object):
    def setupUi(self, Droplet_formation):
        ...
        self.valveLcd_1.setGeometry(QtCore.QRect(160, 490, 120, 50))
        self.valveLcd_1.setObjectName("valveLcd_1")
        self.valveButton_1 = QtWidgets.QPushButton(self.centralwidget)
        self.valveButton_1.setGeometry(QtCore.QRect(90, 600, 90, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.valveButton_1.setFont(font)
        self.valveButton_1.setObjectName("valveButton_1")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(290, 520, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.horizontalSlider = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider.setGeometry(QtCore.QRect(130, 560, 231, 22))
        self.horizontalSlider.setMaximum(255)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.lcdnumber_1 = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcdnumber_1.setGeometry(QtCore.QRect(50, 560, 64, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lcdnumber_1.setFont(font)
        self.lcdnumber_1.setObjectName("lcdnumber_1")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(220, 620, 141, 31))
        self.comboBox.setObjectName("comboBox")
        self.flowrate = QtWidgets.QLCDNumber(self.centralwidget)
        self.flowrate.setGeometry(QtCore.QRect(520, 490, 121, 51))
        self.flowrate.setObjectName("flowrate")
        self.unit_display = QtWidgets.QLabel(self.centralwidget)
        self.unit_display.setGeometry(QtCore.QRect(650, 510, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.lcdnumber_2.setGeometry(QtCore.QRect(50, 760, 64, 23))
        self.lcdnumber_2.setObjectName("lcdnumber_2")
        self.valveButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.valveButton_2.setGeometry(QtCore.QRect(90, 790, 90, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.valveButton_2.setFont(font)
        self.valveButton_2.setObjectName("valveButton_2")
        self.comboBox_2 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_2.setGeometry(QtCore.QRect(220, 810, 141, 31))
        self.comboBox_2.setObjectName("comboBox_2")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(290, 730, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.valveLcd_2 = QtWidgets.QLCDNumber(self.centralwidget)
        self.valveLcd_2.setGeometry(QtCore.QRect(160, 700, 120, 50))
        self.valveLcd_2.setObjectName("valveLcd_2")
        self.horizontalSlider_2 = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(130, 760, 231, 22))
        ...
        self.label_7.setGeometry(QtCore.QRect(120, 20, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.label_5.setGeometry(QtCore.QRect(50, 80, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.label_3.setGeometry(QtCore.QRect(220, 80, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.label_4.setGeometry(QtCore.QRect(220, 120, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.label_10.setGeometry(QtCore.QRect(30, 700, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(30, 480, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_11.setFont(font)
        self.label_11.setObjectName("label_11")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(20, 680, 391, 16))
    ...
    def retranslateUi(self, Droplet_formation):
        ...
        self.unit_display.setText(_translate("Droplet_formation", "(Sensor Disconnected)"))
